...
import { useState } from "react";import { useAdminMutation, useAdminQuery } from "../lib/hooks/use-api";import { Plus, Edit, Trash2, Users, Globe } from "lucide-react";
interface Domain { id:string;domain:string;is_primary:boolean }
interface TenantData { id:string;code:string;name:string;status:string;status_reason?:string;domains?:Domain[] }
