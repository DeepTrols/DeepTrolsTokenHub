...
export default function UsageStats() {
  ...
  if (models.length===0 && trends.length===0) return <div><div className="mb-6"><h2 className="text-2xl font-bold">用量统计</h2></div><Card><CardContent className="p-12 text-center"><p className="text-muted-foreground text-lg">暂无用量数据</p></CardContent></Card></div>;
  return (
    <div>
